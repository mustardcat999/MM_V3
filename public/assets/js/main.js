(function ($) {
    ...
    const originalInsertAfter = $.fn.insertAfter;
    const originalInsertBefore = $.fn.insertBefore;
  
    const markOriginalParent = function (elements) {
      elements.each(function () {
        const $this = $(this);
        if (!$this.attr("data-original-parent") && $this.parent().length) {
          let parentSelector = "";
          ...
          $this.attr("data-original-parent", parentSelector);
        }
      });
      return elements;
    };
    ...
    $.fn.append = function () {
      const elements = arguments[0] instanceof $ ? arguments[0] : $(arguments[0]);
      markOriginalParent(elements);
    ...
    $.fn.appendTo = function () {
      markOriginalParent(this);
      return originalAppendTo.apply(this, arguments);
    };
  
    $.fn.prependTo = function () {
      markOriginalParent(this);
      return originalPrependTo.apply(this, arguments);
    };
  
    $.fn.insertAfter = function () {
      markOriginalParent(this);
      return originalInsertAfter.apply(this, arguments);
    };
    ...
    const originalAppear = $.fn.appear;
    if (originalAppear) {
      $.fn.appear = function (callback, options) {
        markOriginalParent(this);
        return originalAppear.call(this, callback, options);
      };
    }
  
    console.log("jQuery DOM tracking initialized");
  })(window.jQuery);
...
(function ($) {
    ...
    $('.dropdown').on('mouseenter touchstart', function (e) {
        ...
        if (getWindowWidth() >= menuBreakPoint) {
            ...
            _this.find('.nav-link').off('click').on('click', function (e) {
